...
Limyはコメント付きのgetter/setterを作る時と、.propertiesファイルの編集をする時に使う。

確かEclipseの3.3あたりから、Eclipse標準のプロパティ編集ツールに

「プロパティ名に一致するリテラル」にジャンプできる機能がついたんだけど

SourceForgeで公開されているプロパティエディタでは、その機能が使えず。

Limyのプロパティエディタなら、その機能が使えるので。
